This C# command line program takes a single parameter of the name of the Aim Race Studio XRK file and produces a file by the same name + .TXT in the format used by Cosworth Pi Toolbox for outings.  
